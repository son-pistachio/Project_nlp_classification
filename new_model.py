...
CHECKPOINT_NAME = 'intfloat/multilingual-e5-large-instruct'
...
wandb_logger = WandbLogger(project="bert-classification", log_model=True, name="new_"+now_sys)
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath='checkpoints/new/',
    filename='new-{epoch:02d}-{val_loss:.2f}',
    save_top_k=1,
    mode='min',
)
