...
class roBertLightningModel(LightningModule):
    def __init__(self, bert_pretrained, num_labels=num_classes, lr=lr, total_steps=None):
        super(roBertLightningModel, self).__init__()
...
wandb_logger = WandbLogger(project="bert-classification", log_model=True, name="roberta_"+now_sys)
...
bert_model = roBertLightningModel(CHECKPOINT_NAME, total_steps=total_steps)
